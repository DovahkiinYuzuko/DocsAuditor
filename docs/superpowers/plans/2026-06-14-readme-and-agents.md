# README.md and AGENTS.md Creation Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create README.md and AGENTS.md to document project capabilities, installations, locales, and AI co-development rules.

**Architecture:** Create `AGENTS.md` containing prompt guidelines for AI agents, and `README.md` containing bilingual documentation (Japanese and English) detailing VSIX features, AST analysis, configuration, and limitations.
...
**Files:**
- Create: `c:/Users/rikui/Documents/VSCode/DocsAudit/AGENTS.md`

- [ ] **Step 1: Write AGENTS.md**
  Write the prompt guidelines for AI agents working in this project.
  Content:
  ```markdown
...
- [ ] **Step 2: Commit AGENTS.md**
  ...
  ```bash
  git add AGENTS.md
  git commit -m "[feat] AI協調開発ルール用のAGENTS.mdを追加"
  ```
...
**Files:**
- Create: `c:/Users/rikui/Documents/VSCode/DocsAudit/README.md`

- [ ] **Step 1: Write README.md**
  Write the complete README content in both Japanese and English following the specified format.
  Content:
  ```markdown
  # Docs Auditor
...
- [ ] **Step 2: Commit README.md**
  ...
  ```bash
  git add README.md
  git commit -m "[docs] プロジェクト概要とAI協調ルールを記述したREADME.mdを作成"
  ```
